...
class RobotController(object):
    def __init__(self, robot_name='robot', print_debug=False, email_cred_file='', log_file='', control_rate=800, gripper_attached='default',
                 init_rosnode=True, gripper_params=None):
    ...
    def _init_gripper(self, gripper_attached, gripper_params):
        assert gripper_attached == 'default'
